...
- (id) init {
    if (self = [super init]) {
        ...
        self = [CFFrogNode spriteNodeWithTexture: [eatingFrogArray firstObject]]; // żaba
        ...
        CGPathAddLineToPoint(path, NULL, IS_RETINA_DISPLAY() ? 70 : 140 - offsetX, IS_RETINA_DISPLAY() ? 20 : 400 - offsetY);
